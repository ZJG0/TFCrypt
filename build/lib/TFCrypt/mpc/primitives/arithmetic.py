...
# dependencies:
import torch
from TFCrypt.common.functions import regular
from TFCrypt.common.rng import generate_random_ring_element
from TFCrypt.common.tensor_types import is_float_tensor, is_int_tensor, is_tensor
from TFCrypt.common.util import torch_stack
from TFCrypt.config import cfg
from TFCrypt.cryptensor import CrypTensor
from TFCrypt.cuda import CUDALongTensor
from TFCrypt.encoder import FixedPointEncoder
...
class ArithmeticSharedTensor(object):
    ...
    def PRZS(*size, device=None):
        ...
        """
        from TFCrypt import generators
