...
from TFCrypt.common.rng import generate_kbit_random_tensor
from TFCrypt.common.tensor_types import is_tensor
from TFCrypt.common.util import torch_cat, torch_stack
