...
class Communicator:
    ...
    def print_communication_stats(self):
        ...
        TFCrypt.log("====Communication Stats====")
        TFCrypt.log("Rounds: {}".format(self.comm_rounds))
        TFCrypt.log("Bytes: {}".format(self.comm_bytes))
        TFCrypt.log("Communication time: {}".format(self.comm_time))
